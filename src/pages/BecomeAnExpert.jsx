...
const R2_ILL = 'https://pub-ad204fe9e494441088500b2aa6f689b9.r2.dev/become-an-expert/illustrations'
const iconScheduling = `${R2_ILL}/scheduling.svg`
const iconPayments = `${R2_ILL}/payments.svg`
const iconVideoCalls = `${R2_ILL}/video-calls.svg`
const iconAnalytics = `${R2_ILL}/analytics.svg`
const iconSessionNotes = `${R2_ILL}/session-notes.svg`
const iconProfilePage = `${R2_ILL}/profile-page.svg`
const iconClientAcquisition = `${R2_ILL}/client-acquisition.svg`
const iconDigitalProducts = `${R2_ILL}/digital-products.svg`
const iconGroupSessions = `${R2_ILL}/group-sessions.svg`
const iconReviews = `${R2_ILL}/reviews.svg`
const iconMessaging = `${R2_ILL}/message.svg`
const iconGoalTracking = `${R2_ILL}/goal-tracking.svg`
const R2 = 'https://pub-ad204fe9e494441088500b2aa6f689b9.r2.dev/become-an-expert'
const coach1 = `${R2}/photography/coach-1.jpg`
const coach4 = `${R2}/photography/coach-4.jpg`
const coach8 = `${R2}/photography/coach-8.jpg`
const phoneMockup = `${R2}/photography/phone-mockup.png`
